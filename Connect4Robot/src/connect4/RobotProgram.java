...
public class RobotProgram {
	...
	public static void main(String[] args) {
		...
		MotorFunctions motorFunctions = new MotorFunctions(motorMovementPort, motorPieceFeederPort,
				motorColorSensorPort);
		...
		DispenseGamePieces dispenseGamePieces = new DispenseGamePieces(pieceXYReadMove, motorFunctions, feederEndButton,
				gameLogic, colorCalibrator);
		...
		// Starting calibration and other preparations
		...
		System.out.println("Arbitrator starting!");
		arbitrator.go();

		// Closing the sensor and motor ports
